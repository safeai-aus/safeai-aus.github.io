...
<!-- TODO: Human-verify the NSW Act's assent date, which provisions commenced on assent, and any commencement proclamation, against legislation.nsw.gov.au (direct fetch returned HTTP 403 on 8 September 2026; the assent date and staged commencement were corroborated against law-firm analyses only). -->
...
- 🏛️ **DTA policy for the responsible use of AI in government — staged implementation running to 30 April 2027**
  Version 2.0 of the DTA's *Policy for the responsible use of AI in government* took effect on **15 December 2025** and is mandatory for non-corporate Commonwealth entities, subject to the defence and national intelligence community carve-outs. It sets **staged implementation timeframes** rather than a single commencement date. Within **6 months** of the policy taking effect (15 June 2026), agencies must develop a strategic position on AI adoption. Within **12 months** (December 2026), agencies must designate an accountable use case owner for each in-scope AI use case, create an internal register of in-scope AI use cases and begin AI use case assessments, and must then share the register with the DTA every six months. The remaining requirements also fall in that window: completing an AI impact assessment before deployment; processes to assess, approve and oversee AI use cases; and reporting AI incidents. For **existing use cases not yet assessed**, agencies must determine whether they are in scope and apply all relevant policy actions **by 30 April 2027**. Mandatory foundational AI training for all APS staff is a policy requirement, and all 94 mandatory agencies published public AI transparency statements during 2026. The Department of Finance said agencies had until **July 2026** to appoint a Chief AI Officer; its announcement does not report completion across entities ([Department of Finance](https://www.finance.gov.au/about-us/news/2025/establishing-chief-ai-officers-aps)). ([DTA policy v2.0](https://www.digital.gov.au/ai/ai-in-government-policy); [implementation timeframes](https://www.digital.gov.au/ai/ai-in-government-policy/implementation); [AI use case impact assessment](https://www.digital.gov.au/ai/ai-in-government-policy/ai-use-case-impact-assessment), accessed 8 September 2026)

  <!-- TODO: Human-verify the DTA staged implementation dates, in particular the 12-month requirements and the 30 April 2027 deadline for existing use cases, and confirm whether Chief AI Officer appointments completed across entities. -->
