...
**Children's Online Privacy Code (exposure draft; final Code required by 10 December 2026):** The OAIC released an exposure draft of the **Children's Online Privacy Code** for public consultation on 31 March 2026, with submissions closing 5 June 2026. The Code remained an **exposure draft** at 8 September 2026, with the OAIC still considering consultation feedback. The OAIC is required to prepare the final Code by **10 December 2026**, coinciding with the APP ADM transparency obligations above. As drafted, it would apply to online services (including apps, games, educational tools and websites) that expose children and young people to the highest privacy risks, or are primarily concerned with children's activities. Proposed obligations in the exposure draft include:
...
These are draft requirements, not current legal duties. Once the Code is registered and commences, a breach of the Code will constitute a breach of the Privacy Act and may attract significant civil penalties. The Code complements the Social Media Minimum Age obligation (effective December 2025). Organisations developing or operating AI-enabled consumer-facing services used by children (including EdTech platforms, games and recommendation systems) should begin reviewing the draft obligations now, while treating the final wording as unsettled. ([oaic.gov.au](https://www.oaic.gov.au/news/media-centre/oaic-releases-exposure-draft-of-the-childrens-online-privacy-code), accessed 31 May 2026; [OAIC Children's Online Privacy Code](https://www.oaic.gov.au/privacy/privacy-for-kids/privacy-for-kids-childrens-online-privacy-code), accessed 8 September 2026)

<!-- TODO: Human-verify whether the Children's Online Privacy Code has been registered and its commencement date, and confirm the final obligations against the registered Code rather than the exposure draft. -->
...
!!! tip "Key Regulators"
    ...
    - 🦺 **SafeWork NSW (Workplace AI in NSW):** The NSW **Work Health and Safety Amendment (Digital Work Systems) Act 2026** (passed 12 February 2026; assented **18 February 2026**) will impose specific WHS duties on PCBUs using AI, algorithms, automation or online platforms to allocate work. The principal digital work system duties had **not commenced** at 8 September 2026: commencement is by proclamation and only selected supporting amendments commenced on assent. Do not treat the principal duties as operational until a proclamation is made. See [NSW section in state/territory resources](/business-resources/state-territory-ai-resources/#new-south-wales-nsw) for full provisions. Other states may follow.

<!-- TODO: Verified against legislation.nsw.gov.au (Work Health and Safety Act 2011 amendment history) and the Parliament of NSW on 8 September 2026: Work Health and Safety Amendment (Digital Work Systems) Act 2026 No 5, assented 18 February 2026. Schedule 1[7], [9] and [11] commenced on assent under sec 2(a); Schedule 1[1]-[6], [8] and [10] are recorded as "not in force". Recheck for a commencement proclamation for the remaining provisions and update the commencement statement when one is made. -->
...
- 🏛️ **DTA policy for the responsible use of AI in government — staged implementation running to 30 April 2027**
  Version 2.0 of the DTA's *Policy for the responsible use of AI in government* took effect on **15 December 2025** and is mandatory for non-corporate Commonwealth entities, subject to the defence and national intelligence community carve-outs. It sets **staged implementation timeframes** rather than a single commencement date. Within **6 months** of the policy taking effect (15 June 2026), agencies must develop a strategic position on AI adoption. Within **12 months** (15 December 2026), agencies must designate an accountable use case owner for each in-scope AI use case and maintain a register of accountable use case owners, establish an approach to embed responsible AI practices, implement mandatory training for all staff on responsible AI use, and begin AI use case assessments. The remaining requirements also fall in that window: completing an AI impact assessment before deployment; processes to assess, approve and oversee AI use cases; and reporting AI incidents. For **existing use cases not yet assessed**, agencies must determine whether they are in scope and apply all relevant policy actions **by 30 April 2027**. All 94 mandatory agencies published public AI transparency statements during 2026. The Department of Finance said agencies had until **July 2026** to appoint a Chief AI Officer; its announcement does not report completion across entities ([Department of Finance](https://www.finance.gov.au/about-us/news/2025/establishing-chief-ai-officers-aps)). ([DTA policy v2.0](https://www.digital.gov.au/ai/ai-in-government-policy); [strategy and oversight](https://www.digital.gov.au/ai/AI-in-government-policy/strategy-and-oversight); [preparedness and operations](https://www.digital.gov.au/ai/AI-in-government-policy/preparedness-and-operations); [AI use case impact assessment](https://www.digital.gov.au/ai/AI-in-government-policy/ai-use-case-impact-assessment), accessed 8 September 2026)

  <!-- TODO: The staged implementation timeframes above (6-month strategic position, the 12-month requirements and the 30 April 2027 deadline for existing unassessed use cases) were verified against digital.gov.au on 8 September 2026. Still unconfirmed: whether Chief AI Officer appointments completed across all mandatory entities by the July 2026 date; the Department of Finance announcement does not report completion. -->
