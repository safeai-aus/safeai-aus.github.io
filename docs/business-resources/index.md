...
!!! tip "Where to Start"
    === "🆕 New to AI?"
        1. Start with [Safe AI Adoption - Getting Started](safe-ai-adoption-getting-started.md)
        2. Check [AI Grants & Funding](ai-grants-funding-australia.md) for financial support
        3. Explore [AI Learning & Development Directory](ai-learning-development-directory.md) for training
        4. Review the [Governance Templates](../governance-templates/policy-template-library.md) section for implementation guides

    === "🎓 Building Internal Capability?"
        1. Start with [AI Learning & Development Directory](ai-learning-development-directory.md)
        2. Review [Tools & Frameworks](ai-aus-tools-frameworks.md) for suitable platforms
        3. Check [State & Territory AI Resources](state-territory-ai-resources.md) for local programs

---

!!! success "Key Principles for Safe AI Adoption"
    These resources are built around core principles:

    - 🌱 **Start small** — Pilot projects before enterprise-wide deployment
    - 🎓 **Build capability** — Invest in training alongside technology
...
!!! info "Support & Community"
    ...
    **Industry Associations**
    ...
    Many industry bodies provide sector-specific AI guidance — check your relevant association for tailored resources.
