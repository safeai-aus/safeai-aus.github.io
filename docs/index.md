...
[Browse Templates :material-file-document:](governance-templates/policy-template-library.md){ .md-button }
</div>
...
-   :material-rocket-launch:{ .lg .middle } **New to AI Adoption?**
...
-   :material-file-document-multiple:{ .lg .middle } **Need Governance Templates?**

    ---

    Complete library of 11 templates for safe AI implementation

    [:octicons-arrow-right-24: Template Library](governance-templates/policy-template-library.md)

-   :material-cash-multiple:{ .lg .middle } **Looking for Funding?**

    ---

    Current Australian government and state funding opportunities

    [:octicons-arrow-right-24: Grants & Funding](business-resources/ai-grants-funding-australia.md)

-   :material-scale-balance:{ .lg .middle } **Understanding Regulations?**
...
<div class="newsletter-section" markdown>

### Get Practical AI Safety Tools & Updates

Subscribe for practical tools to make AI safe — and work for your growth.
...
<div class="resource-column" markdown>

### :lucide-flag: AI Standards & Legislation
...
- [AI Risks by Industry](governance-templates/ai-risks-by-industry.md)
- [Assurance & Reporting](governance-templates/ai-assurance-transparency-auditing-reporting.md)

### :lucide-briefcase: Business Resources

- [AI Grants & Funding](business-resources/ai-grants-funding-australia.md)
- [Tools & Frameworks](business-resources/ai-aus-tools-frameworks.md)
- [State & Territory Resources](business-resources/state-territory-ai-resources.md)
- [Learning Directory](business-resources/ai-learning-development-directory.md)

</div>

<div class="resource-column" markdown>

### :material-clipboard-list: Getting Started

- [Safe AI Adoption Guide](business-resources/safe-ai-adoption-getting-started.md)
- [AI Readiness Checklist](governance-templates/ai-readiness-checklist.md)
- [AI Implementation Roadmap](governance-templates/ai-implementation-roadmap.md)
- [AI Change Management](governance-templates/ai-change-management.md)

### :material-file-document: Policies & Forms

- [AI Use Policy](governance-templates/ai-use-policy.md)
...
<div class="homepage-footer" markdown>
