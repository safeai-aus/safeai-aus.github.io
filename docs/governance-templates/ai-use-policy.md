...
This page provides a reusable **AI Use Policy** for Australian businesses seeking to adopt AI responsibly.  

- **Intended use:** Adapt and customise the template to suit your organisation's context.  
- **Before adoption:** Review with legal counsel, governance, or compliance officers.  
- **Format:** The policy text below can be copied into your own governance documents.  
...
“This policy template was developed by SafeAI-Aus and is licensed under CC BY 4.0. Source: [SafeAI-Aus](https://safeaiaus.org/).”  
